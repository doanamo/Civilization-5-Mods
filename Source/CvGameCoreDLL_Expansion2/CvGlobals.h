...
//World War
	...
	inline int getSPY_TO_MINOR_RATIO()
	{
	return m_iSPY_TO_MINOR_RATIO;
	}
#endif
...
//Weight for City Target if Liberation Quest Active
	...
	inline int getCSD_GAME_DIFFICULTY_MULTIPLIER()
	{
		return m_iCSD_GAME_DIFFICULTY_MULTIPLIER;
	}
#endif
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iCSD_GAME_DIFFICULTY_MULTIPLIER;
#endif
